...
<img src="MySQL基础篇.assets/{914449A9-31D8-40F7-82A6-B5694D247E9C}.png" alt="image-{914449A9-31D8-40F7-82A6-B5694D247E9C}.png" style="float:left;" />
...
### 2.2数据库与数据库管理系统的关系
数据库管理系统可以管理多个数据库，一般开发人员会针对每个应用创建一个数据库。为保存应用中实体的数据，一般会在数据库创建多个表，以保存程序中实体用户的数据。
数据库管理系统、数据库、表的关系入图所示：
